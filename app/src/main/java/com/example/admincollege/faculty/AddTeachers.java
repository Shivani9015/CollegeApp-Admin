...
public class AddTeachers extends AppCompatActivity {
    ...
    private String name,email,post,downdloadUrl = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items =new String[]{"Select Category"," Computer Science","Electrical and Electronics","Civil","Mechanical","Chemical"};
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            filePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    downdloadUrl = String.valueOf(uri);
                                    insertData();
                                }
                            });
                        }
    ...
    private void insertData() {
       ...
       TeaherData teacherData = new TeaherData(name,email,post,downdloadUrl,uniquekey);
